# ESS Registry Compliance and Mockup

# Mockoon API
This is a mock application which performs API standards spec for a ESS
...
To introduce changes in API definition it is necessary to change content of mockoon-ess.json file. It can be done using mockoon application.
...
Go to [helpers](https://github.com/spdci/ESS-Mockup-Compliance/blob/master/test/features/support/helpers/helpers.js) and update the localhost url to point to your ESS URL. 
Go to test folder and use shell script test_entrypoint.sh to run the tests against your api once test is complete in [result folder](https://github.com/spdci/ESS-Mockup-Compliance/tree/master/test/result)
